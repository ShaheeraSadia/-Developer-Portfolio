...
export const Hero: React.FC<HeroProps> = ({ onOpenResume, onNavigate }) => {
  ...
  return (
    <section
      id="hero-section"
      className="bg-[#1f242d] text-white py-14 sm:py-20 relative overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Main Grid: Left Greeting & Info, Right Circular Glowing Avatar */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#323946] border border-[#00eeff]/30 text-xs font-mono text-[#00eeff] shadow-[0_0_12px_rgba(0,238,255,0.25)]">
            ...
            {/* Social Link Bar with Glowing Cyan Hover Rings */}
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full bg-[#323946] border border-[#00eeff]/30 text-white flex items-center justify-center hover:text-[#00eeff] hover:border-[#00eeff] hover:shadow-[0_0_15px_#00eeff] hover:scale-110 transition-all duration-300"
              >
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-[#323946] border border-[#00eeff]/30 text-white flex items-center justify-center hover:text-[#00eeff] hover:border-[#00eeff] hover:shadow-[0_0_15px_#00eeff] hover:scale-110 transition-all duration-300 cursor-pointer"
            ...
            {/* Action Buttons: Download CV / View Resume & Quick Actions */}
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                onClick={onOpenResume}
                id="hero-cv-btn"
                className="px-5 py-2.5 rounded-xl bg-[#00eeff] text-[#1f242d] font-bold text-sm font-mono hover:bg-[#55f3ff] hover:shadow-[0_0_20px_#00eeff] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 flex items-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-[#323946] text-white font-semibold text-sm font-mono border border-[#00eeff]/30 hover:border-[#00eeff] hover:text-[#00eeff] hover:shadow-[0_0_15px_rgba(0,238,255,0.3)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 flex items-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-transparent text-gray-300 hover:text-[#00eeff] text-sm font-mono transition-colors cursor-pointer"
              >
          ...
          {/* Right Column: Profile Card / Circular Avatar with Glowing Cyan Border Rings */}
          <div className="lg:col-span-5 flex justify-center items-center">
            <div className="relative group">
              ...
              {/* Main Avatar / Profile Card Container */}
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 rounded-full bg-[#323946] border-4 border-[#00eeff] shadow-[0_0_30px_rgba(0,238,255,0.4)] flex flex-col items-center justify-center p-6 text-center overflow-hidden">
                
                {/* Tech Icon inside */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#1f242d] border-2 border-[#00eeff] flex items-center justify-center mb-3 text-[#00eeff] shadow-[0_0_15px_rgba(0,238,255,0.3)]">
                ...
                <div className="flex items-center gap-1.5 mt-3 px-3 py-1 rounded-full bg-[#1f242d] border border-[#00eeff]/40 text-[11px] font-mono text-gray-200">
                  <span className="w-2 h-2 rounded-full bg-[#00eeff] animate-pulse"></span>
                  <span>5+ Yrs Frontend Dev</span>
                </div>

                {/* Floating Corner Badges */}
                <div className="absolute top-4 right-6 px-2.5 py-1 rounded-md bg-[#1f242d] border border-[#00eeff]/50 text-[10px] font-mono text-[#00eeff] shadow-sm">
                  React 19
                </div>
                <div className="absolute bottom-6 left-6 px-2.5 py-1 rounded-md bg-[#1f242d] border border-[#00eeff]/50 text-[10px] font-mono text-[#00eeff] shadow-sm">
                  Tailwind CSS
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-5 bg-[#323946] rounded-2xl border border-[#00eeff]/20 mt-12 shadow-[0_0_20px_rgba(0,238,255,0.1)]">
        ...
        {/* Interactive Section Launchpad Hub (Click any button to view that section!) */}
        <div className="mt-14 space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#323946] pb-4">
            <div className="space-y-1">
            ...
            {sectionCards.map((card) => {
              ...
              return (
                <button
                  ...
                  className="group p-5 rounded-2xl bg-[#323946] border border-[#323946] hover:border-[#00eeff] text-left transition-all duration-200 hover:shadow-[0_0_20px_rgba(0,238,255,0.25)] hover:-translate-y-1 flex flex-col justify-between cursor-pointer space-y-4"
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="p-2 rounded-xl bg-[#1f242d] border border-[#00eeff]/30 text-[#00eeff] group-hover:bg-[#00eeff] group-hover:text-[#1f242d] group-hover:shadow-[0_0_12px_#00eeff] transition-all">
                        <IconComp className="w-5 h-5" />
                      </div>
                      <span className="px-2 py-0.5 rounded-md text-[10px] font-mono text-[#00eeff] bg-[#1f242d] border border-[#00eeff]/20">
                        {card.badge}
                      </span>
                    </div>
                  ...
                  <div className="pt-3 border-t border-[#1f242d] flex items-center justify-between text-xs font-mono text-[#00eeff]">
